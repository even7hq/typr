---
title: Pacote npm
description: A implementação de referência @even7hq/js no npm e o adaptador Clack.
---
...
Código-fonte do pacote neste monorepo: `packages/js` (workspace `@even7hq/js`). Este site de documentação é o workspace `@even7hq/docs`.
